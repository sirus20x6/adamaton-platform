"""SDK-wrapped LinkUp plugin class.

Two RPCs (SearchQuery, SearchFetch). Adapter is constructed lazily;
config (api key, base url, depth) is read from env so the legacy
...
class Plugin:
    """LinkUp search plugin."""

    def __init__(self) -> None:
        self._adapter = LinkUpAdapter()
